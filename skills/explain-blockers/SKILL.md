...
description: Explain remaining review questions and recommendations using development-workflow.
---

# explain-blockers

Compatibility alias for the installed development-workflow skill.
Read [development-workflow](../development-workflow/SKILL.md) and follow its `explain` operation with these inputs: `$ARGUMENTS`.
...
Use the recent review result; do not restart the review or mutate code merely to explain it.
